...
\begin{wrapfigure}{O}{0.5\textwidth}
    \includegraphics[width=0.48\textwidth]{figures/b007}
\end{wrapfigure}
...
don't;" and Meg shook her head, as she thought
regretfully of all the pretty things she wanted.

``But I don't think the little we should spend would do
any good. We've each got a dollar, and the army
wouldn't be much helped by our giving that. I agree not
to expect anything from mother or you, but I do want to buy Undine and
Sintram for myself; I've wanted it \emph{so} long," said
...
and my hands get so stiff, I can't practise well at
...
isn't rich, and insult you when your nose
isn't nice."

``If you mean \emph{libel}, I'd say so, and not talk
about \emph{labels}, as if papa was a pickle-bottle," advised Jo,
laughing.

``I know what I mean, and you needn't be
\emph{statirical} about it. It's proper to use good
words, and improve your \emph{vocabilary}," returned Amy, with dignity.

``Don't peck at one another, children.
Don't you wish we had the money papa lost when we were
little, Jo? Dear me! how happy and good we'd be, if we
...
didn't matter so much when you were a little girl; but
now you are so tall, and turn up your hair, you should remember that you
are a young lady."

``I'm not! and if turning up my hair makes me one,
I'll wear it in two tails till I'm
twenty," cried Jo, pulling off her net, and shaking down a chestnut
mane. ``I hate to think I've got to grow up, and be Miss
March, and wear long gowns, and look as prim as a China-aster!
It's bad enough to be a girl, anyway, when I like
boys' games and work and manners! I
can't get over my disappointment in not being a boy; and
it's worse than ever now, for I'm dying
...
prim. Your airs are funny now; but you'll grow up an
affected little goose, if you don't take care. I like
your nice manners and refined ways of speaking, when you
don't try to be elegant; but your absurd words are as
bad as Jo's slang."
...
woman, and didn't like it. Elizabeth---or Beth, as every
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b008}
\end{wrapfigure}
...
Beth; ``let's each get her something for Christmas, and
...
it won't cost much, so I'll have some
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b009}
\end{wrapfigure}
...
I'm getting too old for such things," observed Meg, who
...
are the best actress we've got, and
there'll be an end of everything if you quit the
...
can't, I shall fall into a chair and be graceful; I
don't care if Hugo does come at me with a pistol,"
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b010}
\end{wrapfigure}

``Do it this way; clasp your hands so, and stagger across the room,
crying frantically, `Roderigo! save me! save
me!'" and away went Jo, with a melodramatic scream which
was truly thrilling.
...
and if the audience laugh, don't blame me. Come on,
Meg."
...
``It's the best we've had yet," said Meg,
...
Witch's Curse, an Operatic Tragedy,' is
rather a nice thing; but I'd like to try Macbeth, if we
...
Beth's stage-struck!" cried Meg, and the rehearsal ended
...
getting the boxes ready to go to-morrow, that I didn't
...
\emph{vivan}---what's its name? or a nurse, so I could
...
work faithfully as long as he can, and we won't ask for
...
at the end did the writer's heart overflow with fatherly
love and longing for the little girls at home.

\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b011}
\end{wrapfigure}
...
mother's shoulder and sobbed out, ``I \emph{am} a selfish
girl! but I'll truly try to be better, so he
...
`a little woman,' and not be rough and
...
milk we had up at the top. If I wasn't too old for such
things, I'd rather like to play it over again," said
...
one grumbled. They adopted Jo's plan of dividing the
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b013}
\end{wrapfigure}
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b014}
\end{wrapfigure}
