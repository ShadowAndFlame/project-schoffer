...
with a skill that brought tears of pride to Hannah's
...
dat's my lellywaiter, and me's trying to
pull her up."
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b189}
\end{wrapfigure}
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b190}
\end{wrapfigure}
...
``Does I?" and Demi's brown eyes grew big and bright as
...
He's getting great bumps over his eyes, and learning to
...
gentleman could only join in grandma's laugh, and
...
prophesy, with ominous nods, ``That child ain't long for
...
hadn't the heart to insult a rival who kept a mine of
...
but Demi didn't see it in that light, and continued to
...
deceive anybody a particle. Mr. Bhaer's devotion was
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b191}
\end{wrapfigure}
...
\emph{Don't} little boys like little girls?" added Demi,
...
```Tisn't in mine head;
it's in mine mouf," answered literal Demi, putting out
...
Like young Washington, Mr. Bhaer ``couldn't tell a lie;"
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b192}
\end{wrapfigure}
