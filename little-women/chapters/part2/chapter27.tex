\chapter{Literary Lessons}

\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b127}
\end{wrapfigure}
...
was rewarded with a new idea. It was a People's Course,
...
and bonnets to match, discussing Woman's Rights and
...
saying bluntly, ``Want to read it? That's a first-rate
story."
...
author's invention fails, a grand catastrophe clears the
...
saying that if the tale didn't get the prize, which the
writer hardly dared expect, she would be very glad to receive any sum it
might be considered worth.

\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b128}
\end{wrapfigure}
...
``Oh, how splendid! No, I can't do it, dear, it would be
...
that's what I tried for, and that's why
I succeeded. I never get on when I think of myself alone, so it will
help me to work for you, don't you see? Besides, Marmee
needs the change, and she won't leave you, so you
\emph{must} go. Won't it be fun to see you come home
...
didn't come home as plump and rosy as could be desired,
...
turned into comforts for them all. ``The Duke's Daughter"
paid the butcher's bill, ``A Phantom Hand" put down a new
...
was her father's advice; and he practised as he
...
I've been fussing over the thing so long, I really
don't know whether it's good, bad, or
indifferent. It will be a great help to have cool, impartial persons
take a look at it, and tell me what they think of it."

``I wouldn't leave out a word of it;
you'll spoil it if you do, for the interest of the story
...
story,'" interrupted Jo, turning to the
publisher's note.

``Do as he tells you; he knows what will sell, and we
don't. Make a good, popular book, and get as much money
as you can. By and by, when, you've got a name, you can
...
`philosophical and metaphysical,' it
isn't my fault, for I know nothing about such things,
except what I hear father say, sometimes. If I've got
...
candor, which chilled Jo's heart, for a minute, with a
...
pleasing every one, she took every one's advice; and,
...
it's so contradictory that I don't know
...
dire dismay the next. ``This man says `An exquisite book,
full of truth, beauty, and earnestness; all is sweet, pure, and
healthy,'" continued the perplexed authoress. ``The next,
`The theory of the book is bad, full of morbid fancies,
spiritualistic ideas, and unnatural characters.' Now,
as I had no theory of any kind, don't believe in
Spiritualism, and copied my characters from life, I
don't see how this critic \emph{can} be right. Another
says, `It's one of the best American
novels which has appeared for years' (I know better
...
money. I wish I'd printed it whole or not at all, for I
...
author's best education; and when the first soreness was
...
said stoutly; ``and I've got the joke on my side, after
...
my own silly head are pronounced `charmingly natural,
tender, and true.' So I'll comfort
myself with that; and when I'm ready,
I'll up again and take another."

\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b129}
\end{wrapfigure}
