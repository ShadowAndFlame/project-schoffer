\chapter{Artistic Attempts}

\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b123}
\end{wrapfigure}
...
the dinner-bell at her door, in case of fire. Raphael's
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b124}
\end{wrapfigure}
...
Amy's hair, Jo's nose,
Meg's mouth, and Laurie's eyes were
...
tumbled off closet-shelves on to people's heads.
...
court without any rehearsal beforehand, she'd know
exactly what to do."
...
every one, so don't ruffle up, like a dear, motherly
...
(Hannah's pronunciation of \emph{char-à-banc}.)

``All this will be expensive, Amy."

``Not very; I've calculated the cost, and
...
don't need, and attempting a style not in keeping with
our circumstances?"
...
why I can't if I'm willing to pay for
...
I'll say no more. Talk it over with the girls, and
whichever way you decide, I'll do my best to help you."
...
don't care a sixpence for you? I thought you had too
...
``I \emph{don't} truckle, and I hate being patronized as
...
and there's a great deal of kindness and sense and
talent among them, in spite of what you call fashionable nonsense. You
don't care to make people like you, to go into good
...
argument. Amy's definition of Jo's idea
...
week's work was deranged, and prophesied that ``ef the
washin' and ironin'
warn't done reg'lar
nothin' would go well anywheres." This hitch in the
mainspring of the domestic machinery had a bad effect upon the whole
concern; but Amy's motto was ``Nil desperandum," and
having made up her mind what to do, she proceeded to do it in spite of
all obstacles. To begin with, Hannah's cooking
didn't turn out well: the chicken was tough, the tongue
too salt, and the chocolate wouldn't froth properly.
...
``If it hadn't been for mother I never should have got
...
little, blew a little, and didn't make up its mind till
...
``I can't get any lobsters, so you will have to do
...
it. I'm very sorry, Amy," added Beth, who was still a
patroness of cats.

``Then I \emph{must} have a lobster, for tongue alone
won't do," said Amy decidedly.

``Shall I rush into town and demand one?" asked Jo, with the magnanimity
of a martyr.

``You'd come bringing it home under your arm, without any
paper, just to try me. I'll go myself," answered Amy,
...
Laurie's most elegant college friends. Fervently hoping
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b125}
\end{wrapfigure}

``Oh, really, I beg pardon; it's an uncommonly fine one,
isn't it?" said Tudor, with great presence of mind, and
...
I sha'n't see them;
that's a comfort," thought Amy, as Tudor bowed and
departed.
...
o'clock all was ready again. Feeling that the neighbors
were interested in her movements, she wished to efface the memory of
yesterday's failure by a grand success to-day; so she
...
I'll go into the porch to meet them; it looks
...
much company, and I can't make such delicious stuff as
...
``It's a pity Laurie isn't here to help
...
like messes. I'm sick of the sight of this; and
there's no reason you should all die of a surfeit
because I've been a fool," cried Amy, wiping her eyes.
...
``I \emph{am} satisfied; I've done what I undertook, and
it's not my fault that it failed; I comfort myself with
that," said Amy, with a little quiver in her voice. ``I thank you all
very much for helping me, and I'll thank you still more
if you won't allude to it for a month, at least."

No one did for several months; but the word "\emph{fête}" always
produced a general smile, and Laurie's birthday gift to
Amy was a tiny coral lobster in the shape of a charm for her
watch-guard.

\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b126}
\end{wrapfigure}
