...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b155}
\end{wrapfigure}
...
giant's treasures, if I remember rightly. But the ``up
...
``Excuse me, I was looking for the `Weekly
Volcano' office; I wished to see Mr. Dashwood."
...
We've more of this sort of thing on hand than we know
what to do with at present; but I'll run my eye over it,
...
don't object to a few alterations. It's
too long, but omitting the passages I've marked will
...
asked to cut off her baby's legs in order that it might
...
Mr. Dashwood's editorial gravity relaxed into a smile,
...
don't sell nowadays;" which was not quite a correct
statement, by the way.

``You think it would do with these alterations, then?"

``Yes; it's a new plot, and pretty well worked
up---language good, and so on," was Mr. Dashwood's
affable reply.
...
``Well, we'll look at it; can't promise
...
womanliest attributes of a woman's character. She was
...
other people's passions and feelings set her to studying
...
discovered that genuine good-will towards one's
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b156}
\end{wrapfigure}
...
conversation was miles beyond Jo's comprehension, but
...
the wise men argued well; but he didn't know when he was
...
``It's evident he doesn't look in his
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b157}
\end{wrapfigure}
...
didn't know what to make of her, and stopped at last, to
...
I've no right to say anything," as many people would
have done; he only remembered that she was young and poor, a girl far
away from mother's love and father's
...
Jo's needle threaded, he was ready to say quite
...
it, I don't see any harm in supplying it. Many very
...
are only silly, never bad, so I won't be worried;" and
...
have got on the Professor's mental or moral spectacles
...
for each is more sensational than the last. I've gone
blindly on, hurting myself and other people, for the sake of money; I
know it's so, for I can't read this
...
\begin{wrapfigure}{O}{0.5\textwidth}
	\includegraphics[width=0.48\textwidth]{figures/b158}
\end{wrapfigure}
...
``I think I haven't done much harm \emph{yet}, and may
keep this to pay for my time," she said, after a long meditation, adding
impatiently, ``I almost wish I hadn't any conscience,
it's so inconvenient. If I didn't care
about doing right, and didn't feel uncomfortable when
doing wrong, I should get on capitally. I can't help
wishing sometimes, that father and mother hadn't been so
...
``I don't know anything; I'll wait till I
do before I try again, and, meantime, `sweep mud in the
street,' if I can't do better;
that's honest, at least;" which decision proved that her
...
were inconsolable, and Mr. Bhaer's hair stuck straight
...
Bhaer's face suddenly recalled the fact that she might
...
didn't know what would have become of her. Fortunately,
...
``Well, the winter's gone, and I've
written no books, earned no fortune; but I've made a
friend worth having, and I'll try to keep him all my
life."
